...
/**
 * Mobile hook for fetching trending posts from backend API
 *
...
/**
 * Hook for fetching trending posts (sorted by recent engagement)
 *
 * Handles:
 * - API call to GET /discover/trending with pagination
